...
public:
	...
	[[nodiscard]] inline bool contains(char c) const { return find(c) != std::string::npos; }
	[[nodiscard]] inline bool contains(const String& str) const { return find(str) != std::string::npos; }
